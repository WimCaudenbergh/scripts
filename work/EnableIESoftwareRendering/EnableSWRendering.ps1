...
$RegistryInstance = @{'Name' = 'SoftwareFallback'; 'Type' = 'Dword'; 'Value' = '1'; 'Path' = 'SOFTWARE\Microsoft\Internet Explorer\GPU'}
Set-RegistryValueForAllUsers

$RegistryInstance = @{'Name' = 'Wow64-SoftwareFallback'; 'Type' = 'Dword'; 'Value' = '1'; 'Path' = 'SOFTWARE\Microsoft\Internet Explorer\GPU'}
Set-RegistryValueForAllUsers
